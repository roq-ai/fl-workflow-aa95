...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['atendimento', 'creator', 'project-manager', 'administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Creators', path: '/creators', entity: 'creator', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
